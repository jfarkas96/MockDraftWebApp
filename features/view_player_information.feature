Feature: View information about individual players
  ...
  As a visitor, 
  I want to be able to view information for each individual player in the draft
  
  Scenario: As a visitor I want to be able to navigate from the home page to individual players pages
